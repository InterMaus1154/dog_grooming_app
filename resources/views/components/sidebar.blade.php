<aside x-bind:class="open ? 'w-full sm:w-80' : 'w-0 overflow-hidden'"
    ...
    <div class="p-4 flex flex-col gap-4">
        <h1 class="text-4xl text-center font-bold italic">
            <a href="/">GabiGrooming</a>
        </h1>
        <nav>
            <ul class="flex flex-col gap-2">
                <li>
                    <a href="/" class="bg-white block text-center text-xl hover:bg-brand-dark hover:text-white transition-all duration-200 font-bold rounded-md py-1 cursor-pointer">Home</a>
                </li>
                <li>

            ...
            <ul class="flex flex-col gap-2">
                ...
                <li>
                    <a href="{{route('dogs.index')}}"
                       class="{{request()->routeIs('dogs.*') ? $active : $inactive}} block text-xl text-center transition-all duration-200 font-bold rounded-md py-1 cursor-pointer shadow-md">
                        Dogs
                    </a>
                </li>
                <li>
                    <a href="{{route('customers.index')}}"
                       class="{{request()->routeIs('customers.*') ? $active : $inactive}} text-xl block text-center transition-all duration-200 font-bold rounded-md py-1 cursor-pointer shadow-md">
                        Customers (owners)
                    </a>
                </li>
                <li>
